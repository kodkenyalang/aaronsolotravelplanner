...
/**
 * @title UnoLoyaltyToken
 * @dev ERC20 token for the UnoTravel loyalty program
 */
contract UnoLoyaltyToken is ERC20, Ownable {
    ...
    constructor() ERC20("UnoTravel Loyalty Token", "ULT") {
